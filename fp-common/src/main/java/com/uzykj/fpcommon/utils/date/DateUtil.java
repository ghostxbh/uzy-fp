package com.uzykj.fpcommon.utils.date;
...
public class DateUtil {
 ...
 public static Date getNowDate() {
  ...
  String dateString = DateUtil.DATE_TIME.format(currentTime);
  ParsePosition pos = new ParsePosition(8);
  Date currentTime_2 = DateUtil.DATE_TIME.parse(dateString, pos);
 ...
 public static Date getNowDateShort() {
  Date currentTime = new Date();
  String dateString = DateUtil.DATE.format(currentTime);
  ParsePosition pos = new ParsePosition(8);
  Date currentTime_2 = DateUtil.DATE.parse(dateString, pos);
  return currentTime_2;
 }
 ...
 public static String getTimeShort() {
  Date currentTime = new Date();
  String dateString = DateUtil.TIME.format(currentTime);
  return dateString;
 }
 ...
 public static Date strToDateLong(String strDate) {
  ...
  Date strtodate = DateUtil.DATE_TIME.parse(strDate, pos);
  return strtodate;
 }
 ...
 public static String dateToStrLong(Date dateDate) {
  String dateString = DateUtil.DATE_TIME.format(dateDate);
  return dateString;
 }
 ...
 public static String dateToStr(Date dateDate) {
  String dateString = DateUtil.DATE.format(dateDate);
  return dateString;
 }
 ...
 public static Date strToDate(String strDate) {
  ParsePosition pos = new ParsePosition(0);
  Date strtodate = DateUtil.DATE.parse(strDate, pos);
  return strtodate;
 }
 ...
 public static String getLastDateOfString(String yearMonth){
     ...
     //格式化日期
     String lastDayOfMonth = DateUtil.DATE.format(cal.getTime());
 ...
 public static String getStringToday() {
  Date currentTime = new Date();
  String dateString = DateUtil.DATE_TIME_OF_SHORT.format(currentTime);
  return dateString;
 }
  ...
  * 
  * @param DateUtil.DATE_TIME : "yyyy-MM-dd HH:mm:ss"
  * 		...
  *            
  * @return
  */
 ...
 public static String getTwoDay(String sj1, String sj2) {
  long day = 0;
  try {
   Date date = DateUtil.DATE.parse(sj1);
   Date mydate = DateUtil.DATE.parse(sj2);
 ...
 public static String getPreTime(String sj1, String jj) {
  String mydate1 = "";
  try {
   Date date1 = DateUtil.DATE_TIME.parse(sj1);
   long Time = (date1.getTime() / 1000) + Integer.parseInt(jj) * 60;
   date1.setTime(Time * 1000);
   mydate1 = DateUtil.DATE_TIME.format(date1);
  } catch (Exception e) {
  }
  return mydate1;
 }
 ...
 public static String getEDate(String str) {
  ParsePosition pos = new ParsePosition(0);
  Date strtodate = DateUtil.DATE.parse(str, pos);
 ...
 public static String getWeek(String sdate, String num) {
  ...
  return DateUtil.DATE.format(c.getTime());
 }
 ...
 public static long getDays(String date1, String date2) {
  ...
  Date mydate = null;
  try {
   date = DateUtil.DATE.parse(date1);
   mydate = DateUtil.DATE.parse(date2);
  } catch (Exception e) {
  }
 ...
 public static String getNo(int k) {
  ...
  return getUserDate(DateUtil.DATE_TIME_OF_SHORT_NOSPACE) + getRandom(k);
 }
 ...
 public static String getDateString(long dateLong) {
	...
	String sDateTime = DateUtil.DATE_TIME.format(dt);  //得到精确到秒的表示：08/31/2006 21:08:00
 ...
 public static boolean RightDate(String date) {
  ...
  SimpleDateFormat sdf = DateUtil.DATE_TIME;
  ;
  if (date == null)
   return false;
  if (date.length() > 10) {
   sdf = DateUtil.DATE_TIME_OF_hh;
  } else {
   sdf = DateUtil.DATE;
  }
  try {
 ...
 */
 public static String getPrevMonth(String currentDate) {
	 ...
	 Date date = null;  
     try {  
         date = DateUtil.YEAR_MONTH.parse(currentDate);  
	 ...
	 return DateUtil.YEAR_MONTH.format(c.getTime());
 ...
 public static String getPrevMonthOfShort(String currentDate) {
     ...
     try {  
         date = DateUtil.YEAR_MONTH_OF_SHORT.parse(currentDate);  
     } catch (ParseException e) { 
         e.printStackTrace();  
     ...
     c.setTime(date);  
     c.add(Calendar.MONTH, -1);  
	 return DateUtil.YEAR_MONTH_OF_SHORT.format(c.getTime());
 } 
 ...
 public static boolean isBefore(String  startMonth, String endMonth){
	 ...
	 Date endDate = null;
	 try {
		 startDate = DateUtil.YEAR_MONTH.parse(startMonth);
		 endDate = DateUtil.YEAR_MONTH.parse(endMonth);
	} catch (ParseException e) {
		e.printStackTrace();
	}
 ...
 public static String[] getBetweenMonths(String startMonth, String endMonth)throws Exception{
	 ...
	 long start = DateUtil.YEAR_MONTH_OF_SHORT.parse(startMonth).getTime();
	 long end = DateUtil.YEAR_MONTH_OF_SHORT.parse(endMonth).getTime();
	 if(start>end){
	 ...
	 while(current<=end){
		 ...
		 months[months.length-1] =DateUtil.YEAR_MONTH_OF_SHORT.format(date);
...
public static String getFirstDateByPeriod(String yearMonth){
     ...
     //格式化日期
     String firstDayOfMonth = DateUtil.DATE.format(cal.getTime());
